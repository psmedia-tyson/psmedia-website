<?= get_template_part('template-parts/components/ctas/footer-cta'); ?>
<footer class="app-footer">
  <div class="container max-width-adaptive-lg">
    <div class="grid gap-lg">

      <div class="app-branding-wrap col-6">
        <div class="grid gap-lg">
          ...
          <div class="app-tagline col-content">
            <div class="app-tagline__block">
              <div class="app-tagline__block--row">
                <div>
                  <span><em>Digital Marketing</em></span>
                </div>
              </div>
              <div class="app-tagline__block--row">
                <div>
                  <span><em>Traditional Advertising</em></span>
                </div>
              </div>
              <div class="app-tagline__block--row">
                <div>
                  <span><em>Agency</em></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="app-footer-navigation col-3 padding-left-lg">
      ...
      <div class="app-footer-navigation col-3 padding-left-lg">
        <?php if (have_rows('social_navigation', 'option')) : ?>
          <div class="app-social-navigation">
            <?php while (have_rows('social_navigation', 'option')) : the_row(); ?>
              <?php if (have_rows('social')) : ?>
                <?php while (have_rows('social')) : the_row(); ?>

                  <a class="app-social" href="<?php the_sub_field('social_link'); ?>">
                    <div class="app-social__icon" style="background-color: <?php the_sub_field('social_color'); ?>;">
                      <?php the_sub_field('icon'); ?>
                    </div>
                    <div class="app-social__title">
                      <?php the_sub_field('social_network_name'); ?>
                    </div>
                  </a>
  ...
  <div class="app-footer__copyright padding-y-sm">
    <span>© 2024 PS Media, Inc.. All rights Reserved, PS Media, Inc</span>
  </div>
</footer>
